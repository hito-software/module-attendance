...
class AttendanceRequestRejectedNotification extends Notification implements ShouldQueue, ViewNotification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line('Your leave request was rejected.')
    ...
    public static function toView(DatabaseNotification $notification): ?NotificationDTO
    {
        ...
        return new NotificationDTO('Attendance request rejected',
            "Your attendance request for <b>{$model->type?->name}</b> has been rejected.", 'Open',
